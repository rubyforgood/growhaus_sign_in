...
RSpec.describe "users/edit", type: :view do
  ...
  it "renders the edit user form" do
    ...
    assert_select "form[action=?][method=?]", user_path(@user), "post" do
      ...
      assert_select "input#user_emergency_contact_name[name=?]", "user[emergency_contact_name]"

      assert_select "input#user_emergency_contact_phone[name=?]", "user[emergency_contact_phone]"

      assert_select "input#user_waiver_signature[name=?]", "user[waiver_signature]"
